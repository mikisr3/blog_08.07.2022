       ...
       $this->load->view('templates/header_vertical');
		...
		$this->load->view('templates/footer');
												...
												$this->load->view('templates/footer');
													...
													public function marker_images(){

														$data['marker_id']=$this->input->post('testtest');

														$data['lat_id']=$this->input->post('coordlat');

														$data['long_id']=$this->input->post('coordlong');



															//echo $this->input->post('image_title');

															$data['title'] = $this->input->post('image_title');

															$data['images'] = $this->post_model->get_markers_images($this->input->post('testtest'));

															//var_export($data['images']);

														//echo "miki";

															$this->load->view('templates/header_vertical');
												      $this->load->view('posts/marker_images',$data);
												      $this->load->view('templates/footer');
