...
class Googlemapsajax {
	...
	var $map_div_id					= "map_canvas_1";				// The ID of the <div></div> that is output which contains the map
	...
	function create_map()
	{
		...
		return array('jsajax'=>$this->output_js, 'htmlajax'=>$this->output_html, 'markersajax'=>$this->markersInfo);
